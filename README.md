...
Маркетинговый сайт продукта Бизнес-аватары. Лендинг + SEO блог + кейсы. Buildo.ru зонтик.

**Сценарий использования (Сайт):** Лендинг с примерами, тарифы, кейсы, SEO-статьи
